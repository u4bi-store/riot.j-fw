  ...
  <div class="wrapper">
    ...
    <header class="top-header">
      ...
      <div class="top-bar">
        <h2>user.jab</h2>
        <ul>
          <li><a href="https://github.com/u4bi" itemprop="url" target="_blank"><svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
             viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve" width="28">
          <path fill-rule="evenodd" clip-rule="evenodd" fill="#D1CECC" d="M14.01,0C6.27,0-0.01,6.28-0.01,14.02
            ...
            c0,1.87-0.02,3.39-0.02,3.84c0,0.37,0.25,0.81,0.96,0.67c5.56-1.86,9.58-7.11,9.58-13.3C28.03,6.28,21.75,0,14.01,0z"/></svg></a></li>
        </ul>
      </div>
      <div class="top-content"><p>user.bio</p></div>
    </header>
    ...
    <section>
      ...
      <div>
        ...
        <h4>project.charge &bull; project.start_date &mdash; project.end_date</h4>
        <p>project.bio</p>
      </div>
    </section>
    ...
    <section>
      ...
      <div>
        <h3>exper.name</h3>
        <h4>exper.charge &bull; exper.start_date &mdash; exper.end_date - exper.address</h4>
        <ul>
          <li>exper.bio</li>
        </ul>
      </div>
    ...
    <section>
      ...
      <div>
        <h3>edu.title</h3>
        <h4>edu.name &bull; edu.start.date - edu.end.date</h4>
        <h3>cert.title</h3>
        <h4>cert.name &bull; cert.date</h4>
      </div>
    </section>
